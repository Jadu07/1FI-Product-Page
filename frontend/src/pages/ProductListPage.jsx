...
const ProductListPage = () => {
    ...
    return (
        <main className="bg-gray-50 min-h-screen">
            <div className="bg-white border-b border-gray-100 px-4 sm:px-8 py-2 md:py-2.5 text-[10px] sm:text-xs text-gray-400">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-8 py-4 sm:py-8">
                <div className="mb-4 sm:mb-6">
                    <h1 className="text-lg sm:text-xl font-bold text-gray-800">{heading} on EMI</h1>
                    <p className="text-xs sm:text-sm text-gray-400 mt-1">{filtered.length} products available</p>
                </div>
